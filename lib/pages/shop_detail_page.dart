                                    ...
                                    onSelected: (value) async {
                                      switch(value) {
                                        ...
                                        case 'favorite':
                                          ...
                                          _drinkState?.update(updated); // optimistically update ui
                                          supabase // update db in background
                                            .from('drinks')
                                            .update({'is_favorite': !drink.isFavorite})
                                            .eq('id', drink.id)
                                            .then((_) {
                                            }).catchError((error) { // catch and rollback
                                              final reverted = updated.copyWith(isFavorite: drink.isFavorite);
                                              _drinkState?.update(reverted);
                                              ScaffoldMessenger.of(context).showSnackBar(
